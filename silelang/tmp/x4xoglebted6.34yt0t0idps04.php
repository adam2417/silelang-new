    ...
    <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="input-prepend">
                    ...
                    <select name="id_kontraktor"<?php if (!empty($kontraktor_id)): ?>disabled<?php endif; ?>>
                        <?php foreach (($kontraktorlist?:[]) as $kid): ?>
                            <option value="<?= ($kid['id_kontraktor']) ?>" <?php if (!empty($kontraktor_id)): ?><?php if (($kid['id_kontraktor'] == $kontraktor_id)): ?>selected="selected"<?php endif; ?><?php endif; ?>><?= ($kid['id_kontraktor'].' - '.$kid['nama']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div><br/>
                <div class="input-prepend">
