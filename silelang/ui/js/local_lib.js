...
input.addEventListener('mousemove',function(event) { setNumberFormat(); });
input.addEventListener('focus',function(event) { setNumberFormat(); });
input.addEventListener('input',function(event) {  setNumberFormat(); });
